...
Finally, I discovered this [post on how to do what I was looking for using Intune and ServiceUI.exe](https://localerror.com/intune/deploying-bitlocker-with-a-startup-pin-through-intune-and-powershell/).
...
![Showing the PIN prompt that a user will get](images/BitlockerPINPrompt.png)
